using WasteOrganisationsStub.Example.Endpoints;
using WasteOrganisationsStub.Example.Services;
using WasteOrganisationsStub.Config;
using WasteOrganisationsStub.Utils;
using WasteOrganisationsStub.Utils.Http;
using WasteOrganisationsStub.Utils.Mongo;
using System.Diagnostics.CodeAnalysis;
using WasteOrganisationsStub.Utils.Logging;
